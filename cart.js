(() => {
  ...
  const area=document.querySelector('[data-cart-delivery-area]'),areaOut=document.querySelector('[data-cart-delivery-estimate]');if(area){area.value=sessionStorage.getItem('wgh_delivery_area')||'';const syncArea=()=>{sessionStorage.setItem('wgh_delivery_area',area.value);const copy={accra:'Delivery fee will be communicated after your order is confirmed.',tema:'Delivery fee will be communicated after your order is confirmed.',kumasi:'Delivery fee will be communicated after your order is confirmed.',ghana:'Delivery fee will be communicated after your order is confirmed.',international:'International delivery fee and timing will be communicated after your order is confirmed.'};areaOut.textContent=copy[area.value]||'Delivery fee will be communicated after your order is confirmed.'};area.onchange=syncArea;syncArea()}
