...
WGH.products = [{"id":"drapped-halter-mini-dress","name":"Drapped Halter Mini Dress","category":"dresses","retailPrice":200,"wholesalePrice":null,"moq":6,"colours":["Dark Brown","Black","Grey","Baby Blue"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A sculpted halter mini with soft draping through the bodice and a ruched, figure-skimming skirt.","details":"Halter neckline. Draped overlay. Ruched mini silhouette. Made to order.","care":"Gentle wash. Do not bleach. Steam on low heat and store hanging.","images":["images/drapped-halter-mini-dress-dark-brown.jpeg","images/drapped-halter-mini-dress-grey.jpeg","images/drapped-halter-mini-dress-baby-blue.jpeg","images/drapped-halter-mini-dress-black.jpeg"],"colourImages":{"Dark Brown":["images/drapped-halter-mini-dress-dark-brown.jpeg"],"Grey":["images/drapped-halter-mini-dress-grey.jpeg"],"Baby Blue":["images/drapped-halter-mini-dress-baby-blue.jpeg"],"Black":["images/drapped-halter-mini-dress-black.jpeg"]}},{"id":"ruffle-asymmetric-mini-dress","name":"Ruffle Asymmetric Mini Dress","category":"dresses","retailPrice":200,"wholesalePrice":130,"moq":6,"colours":["Pink","White","Black"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A playful asymmetric mini framed with cascading ruffles and delicate shoulder ties.","details":"Asymmetric hem. Ruffle trim. Adjustable tie straps. Made to order.","care":"Cold gentle wash. Do not bleach. Hang or lay flat to dry.","images":["images/ruffle-asymmetric-mini-dress-pink.jpeg","images/ruffle-asymmetric-mini-dress-white.jpeg","images/ruffle-asymmetric-mini-dress-black.jpeg"],"colourImages":{"Pink":["images/ruffle-asymmetric-mini-dress-pink.jpeg"],"White":["images/ruffle-asymmetric-mini-dress-white.jpeg"],"Black":["images/ruffle-asymmetric-mini-dress-black.jpeg"]}},{"id":"ruche-wrap-mini-dress","name":"Ruche Wrap Mini Dress","category":"dresses","retailPrice":250,"wholesalePrice":140,"moq":6,"colours":["Black","Curry","White"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A deep wrap-front mini with gathered ruching that shapes the waist and hip.","details":"Deep V neckline. Wrap-effect front. Ruched mini skirt. Made to order.","care":"Gentle wash with similar colours. Avoid harsh bleach. Steam lightly.","images":["images/ruche-wrap-mini-dress-black.jpeg","images/ruche-wrap-mini-dress-curry.jpeg","images/ruche-wrap-mini-dress-white.jpeg"],"colourImages":{"Black":["images/ruche-wrap-mini-dress-black.jpeg"],"Curry":["images/ruche-wrap-mini-dress-curry.jpeg"],"White":["images/ruche-wrap-mini-dress-white.jpeg"]}},{"id":"nael-mini-dress","name":"Naël Mini Dress","category":"dresses","retailPrice":200,"wholesalePrice":130,"moq":6,"colours":["Red","Orange","Black"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A clean strappy mini cut close to the body with a softly ruched skirt.","details":"Slim straps. V neckline. Body-skimming fit. Ruched mini length. Made to order.","care":"Cold gentle wash. Do not bleach. Dry away from direct heat.","images":["images/nael-mini-dress-red.jpeg","images/nael-mini-dress-orange.jpeg","images/nael-mini-dress-black.jpeg"],"colourImages":{"Red":["images/nael-mini-dress-red.jpeg"],"Orange":["images/nael-mini-dress-orange.jpeg"],"Black":["images/nael-mini-dress-black.jpeg"]}},{"id":"dante-capri","name":"DANTÉ CAPRI","category":"pants","retailPrice":200,"wholesalePrice":140,"moq":6,"colours":["Army Green","Grey","Black","Brown"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A sporty capri trouser with a high waist, cropped flare and contrast side stripes.","details":"High rise. Capri length. Flared hem. Contrast side stripes. Made to order.","care":"Wash inside out on a gentle cycle. Do not bleach. Air dry.","images":["images/dante-capri-army-green.jpeg","images/dante-capri-grey.jpeg","images/dante-capri-black.jpeg","images/dante-capri-brown.jpeg"],"colourImages":{"Army Green":["images/dante-capri-army-green.jpeg"],"Grey":["images/dante-capri-grey.jpeg"],"Black":["images/dante-capri-black.jpeg"],"Brown":["images/dante-capri-brown.jpeg"]}},{"id":"ruched-waist-pants","name":"Ruched Waist Pants","category":"pants","retailPrice":200,"wholesalePrice":140,"moq":6,"colours":["Black","Red","Brown"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"Fluid flare pants finished with a gathered drawstring waist for a sculpted, adjustable fit.","details":"Ruched waist. Adjustable side ties. Wide flare leg. Made to order.","care":"Cold gentle wash. Tie drawstrings loosely before washing. Air dry.","images":["images/ruched-waist-pants-black.jpeg","images/ruched-waist-pants-red.jpeg","images/ruched-waist-pants-brown.jpeg"],"colourImages":{"Black":["images/ruched-waist-pants-black.jpeg"],"Red":["images/ruched-waist-pants-red.jpeg"],"Brown":["images/ruched-waist-pants-brown.jpeg"]}},{"id":"foldover-waist-flare-pants","name":"Foldover Waist Flare Pants","category":"pants","retailPrice":250,"wholesalePrice":145,"moq":6,"colours":["Brown","Black","Nude","Pink"],"sizes":["XS","S","M","L","XL","2XL"],"isNew":true,"available":true,"description":"A soft foldover-waist pant with a cropped, flowing flare that moves easily.","details":"Foldover waistband. Cropped flare leg. Soft stretch feel. Made to order.","care":"Cold gentle wash. Do not bleach. Reshape while damp and air dry.","images":["images/foldover-waist-flare-pants-brown.jpeg","images/foldover-waist-flare-pants-black.jpeg","images/foldover-waist-flare-pants-nude.jpeg","images/foldover-waist-flare-pants-pink.jpeg"],"colourImages":{"Brown":["images/foldover-waist-flare-pants-brown.jpeg"],"Black":["images/foldover-waist-flare-pants-black.jpeg"],"Nude":["images/foldover-waist-flare-pants-nude.jpeg"],"Pink":["images/foldover-waist-flare-pants-pink.jpeg"]}}];
...
WGH.colourValue = name => ({black:'#151515',white:'#f7f5ef',cream:'#e8dfcf',ivory:'#eee9df',bone:'#ddd3c3',nude:'#d3b69c',brown:'#65402f','dark brown':'#4b2d23',cocoa:'#593d32',mocha:'#806451',espresso:'#3d2b24',sand:'#c9b79c',stone:'#999186',taupe:'#9b8b79',camel:'#b98b63',oat:'#d9ccb6',mushroom:'#988979',dust:'#bea99d',grey:'#8f9297',gray:'#8f9297','baby blue':'#b8d8ef',pink:'#ed8db2',red:'#bd1725',orange:'#e66524',curry:'#d99a18','army green':'#626747'}[String(name||'').toLowerCase()]||'#b7aea5');
WGH.productCard = (p,mode='retail') => { const colours=(p.colours||[]).slice(0,6); const imageMap=p.colourImages||{}; const wholesaleReady=Number(p.wholesalePrice)>0; const priceLabel=mode==='wholesale'?(wholesaleReady?WGH.money(p.wholesalePrice):'Wholesale price pending'):WGH.money(p.retailPrice); return `<article class="product-card" data-product-card="${p.id}"><a href="product.html?id=${encodeURIComponent(p.id)}&mode=${mode}" aria-label="View ${p.name}"><div class="product-card-image" data-card-gallery><img class="primary-image" data-card-image src="${p.images?.[0]||''}" alt="${p.name}" loading="lazy"><img class="hover-image" src="${p.images?.[1]||p.images?.[0]||''}" alt="${p.name} alternate colour" loading="lazy"></div><div class="product-card-copy"><div><h3>${p.name}</h3><p>${mode==='wholesale'?'MOQ '+p.moq+' · mix colours & sizes':'Made to order'}</p></div><strong>${priceLabel}</strong></div></a>${colours.length?`<div class="card-colours" aria-label="Available colours">${colours.map((c,i)=>`<button type="button" data-card-colour="${c}" data-card-src="${(imageMap[c]||[])[0]||p.images?.[i]||p.images?.[0]||''}" title="${c}" aria-label="Show ${c}"><i style="--swatch:${WGH.colourValue(c)}"></i></button>`).join('')}<small data-card-colour-name>${colours[0]}</small></div>`:''}<button class="wishlist-card-button" type="button" data-wishlist="${p.id}" aria-label="Save ${p.name}"><i class="fa-regular fa-heart"></i></button></article>` };
